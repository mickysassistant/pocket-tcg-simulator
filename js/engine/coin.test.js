 ...
 * 
 * Run in browser via: import('./js/engine/coin.test.js').then(m => m.runCoinTests())
 * Or from Node.js test runner.
 */
...
function assertEqual(actual, expected, testName) {
  ...
  if (!pass) console.error('❌ FAIL:', testName, '| expected:', expected, '| got:', actual);
}
